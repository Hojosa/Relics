...
public class RelicsPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> AZURITE_ORE_PLACED = createKey("azurite_ore_placed");
	...
	public static void bootstrap(BootstapContext<PlacedFeature> context) {
		...
		register(context, AZURITE_ORE_PLACED, configured.getOrThrow(RelicsConfiguredFeatures.AZURITE_ORE), List.of(RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), BiomeFilter.biome()));
