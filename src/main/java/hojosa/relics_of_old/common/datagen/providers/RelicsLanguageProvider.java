...
//	      addItem(RelicsItems.BRICK_BLUE, "Blue Brick");
		...
		addItem(RelicsItems.STARGLASS_LUMP, "Starglass Lump");
		addItem(RelicsItems.STARSTEEL_INGOT, "Starsteel Ingot");
		addItem(RelicsItems.STARSTEEL_DUST, "Starry Iron Dust");
		addItem(RelicsItems.AZURITE_DUST, "Azurite Dust");
		addItem(RelicsItems.AZURITE_DOT, "Azurite Dot");
		addItem(RelicsItems.ABSTRACTION_GEL, "Abstraction Gel");
		addItem(RelicsItems.DIMENSIONAL_CATALYST, "Dimensional Catalyst");
		addItem(RelicsItems.NUCLEUS_FIRE, "Fire Nucleus");
		addItem(RelicsItems.NUCLEUS_ICE, "Ice Nucleus");
		addItem(RelicsItems.NUCLEUS_LIGHTNING, "Lightning Nucleus");
		addItem(RelicsItems.NUCLEUS_CUT, "Cut Nucleus");
		addItem(RelicsItems.NUCLEUS_SKY, "Sky Nucleus");
		addItem(RelicsItems.NUCLEUS_SUN, "Sun Nucleus");
		addItem(RelicsItems.NUCLEUS_NAVIGATE, "Navigate Nucleus");
		addItem(RelicsItems.NUCLEUS_DARK, "Dark Nucleus");
		addItem(RelicsItems.NUCLEUS_STAR, "Star Nucleus");
		addItem(RelicsItems.NUCLEUS_HEALTH, "Health Nucleus");
		addItem(RelicsItems.NUCLEUS_WEAPON, "Weapon Nucleus");
		addItem(RelicsItems.NUCLEUS_WEALTH, "Wealth Nucleus");
		addItem(RelicsItems.GEM_FIRE, "Fire Gem");
		addItem(RelicsItems.GEM_ICE, "Ice Gem");
		addItem(RelicsItems.GEM_LIGHTNING, "Lightning Gem");
		addItem(RelicsItems.GEM_CUT, "Cut Gem");
		addItem(RelicsItems.GEM_SKY, "Sky Gem");
		addItem(RelicsItems.GEM_SUN, "Sun Gem");
		addItem(RelicsItems.GEM_NAVIGATE, "Navigate Gem");
		addItem(RelicsItems.GEM_DARK, "Dark Gem");
		addItem(RelicsItems.GEM_STAR, "Star Gem");
		addItem(RelicsItems.GEM_HEALTH, "Health Gem");
		addItem(RelicsItems.GEM_WEAPON, "Weapon Gem");
