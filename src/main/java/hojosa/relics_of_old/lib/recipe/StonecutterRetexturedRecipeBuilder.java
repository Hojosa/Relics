package hojosa.relics_of_old.lib.recipe;
...
public class StonecutterRetexturedRecipeBuilder {
	 ...
	 */
	public StonecutterRetexturedRecipeBuilder setSource(Ingredient texture) {
	...
	/**
	 * Sets the match first property on the recipe. If set, the recipe uses the
	 * first ingredient match for the texture. If unset, all items that match the
	 * ingredient must be the same or no texture is applied
	 * 
	 * @return Builder instance
	 */
	public StonecutterRetexturedRecipeBuilder setMatchAll() {
		this.matchAll = true;
		return this;
	}
