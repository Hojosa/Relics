...
public class RelicsParticles {
	...
	public static final RegistryObject<SimpleParticleType> RUNE_PARTICLE = 
			PARTICLE_TYPES.register(References.UnlocalizedName.RUNE_PARTICLE, () -> new SimpleParticleType(true));
}